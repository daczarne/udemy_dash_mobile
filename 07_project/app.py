...
data = {
	...
	"iso_alpha": [
		"AND", "ARE",	"AFG", "ATG",	"AIA", "ALB",	"ARM", "ANT",	"AGO", "ATA",	"ARG", "ASM", "AUT", "AUS",	"ABW", "AZE",	"BIH", "BRB",	"BGD", "BEL",	"BFA", "BGR",	"BHR", "BDI",	"BEN", "BMU",	"BRN", "BOL",	"BRA", "BHS",	"BTN", "BVT", "BWA", "BLR",	"BLZ", "CAN",	"CCK", "COD",	"CAF", "COG", "CHE", "CIV", "COK", "CHL", "CMR", "CHN", "COL", "CRI", "CUB", "CPV", "CXR", "CYP", "CZE", "DEU", "DJI", "DNK", "DMA", "DOM", "DZA", "ECU", "EST", "EGY",	"ESH", "ERI",	"ESP", "ETH",	"FIN", "FJI",	"FLK", "FSM",	"FRO", "FRA", "GAB", "GBR",	"GRD", "GEO",	"GUF", "GGY",	"GHA", "GIB",	"GRL", "GMB",	"GIN", "GLP", "GNQ", "GRC", "SGS", "GTM", "GUM", "GNB", "GUY", "HKG", "HMD", "HND", "HRV", "HTI", "HUN", "IDN", "IRL", "ISR",	"IMN", "IND",	"IOT", "IRQ",	"IRN", "ISL",	"ITA", "JEY", "JAM", "JOR",	"JPN", "KEN",	"KGZ", "KHM",	"KIR", "COM",	"KNA", "PRK",	"KOR", "KWT", "CYM", "KAZ",	"LAO", "LBN",	"LCA", "LIE",	"LKA", "LBR",	"LSO", "LTU",	"LUX", "LVA", "LBY", "MAR",	"MCO", "MDA",	"MNE", "MDG",	"MHL", "MKD",	"MLI", "MMR",	"MNG", "MAC", "MNP", "MTQ",	"MRT", "MSR",	"MLT", "MUS",	"MDV", "MWI",	"MEX", "MYS", "MOZ", "NAM",	"NCL", "NER",	"NFK", "NGA", "NIC", "NLD",	"NOR", "NPL",	"NRU", "NIU",	"NZL", "OMN", "PAN", "PER",	"PYF", "PNG",	"PHL", "PAK",	"POL", "SPM", "PCN", "PRI",	"PSE", "PRT",	"PLW", "PRY", "QAT", "REU",	"ROU", "SRB",	"RUS", "RWA",	"SAU", "SLB",	"SYC", "SDN", "SWE", "SGP",	"SHN", "SVN", "SJM", "SVK",	"SLE", "SMR",	"SEN", "SOM",	"SUR", "SSD",	"STP", "SLV",	"SYR", "SWZ", "TCA", "TCD", "ATF", "TGO",	"THA", "TJK",	"TKL", "TLS",	"TKM", "TUN",	"TON", "TUR",	"TTO", "TUV",	"TWN", "TZA", "UKR", "UGA",	"UMI", "USA",	"URY", "UZB",	"VAT", "VCT",	"VEN", "VGB",	"VIR", "VNM",	"VUT", "WLF", "WSM", "YEM", "MYT", "ZAF",	"ZMB", "ZWE"
	]
} 
...
df_world_f = pd.merge(
	df_countries[["Country", "TotalConfirmed", "TotalDeaths", "TotalRecovered", "CountryCode"]],
	code_mapping,
	left_on = "CountryCode",
	right_on = "alpha-2",
	how = "inner"
...
def world_map(df):
	...
	fig = px.choropleth(
		...
		color_continuous_scale = px.colors.sequential.Plasm
	)
...
body_app = dbc.Container(
	[
		dbc.Row(
			html.Marquee("USA, India and Brazil are top 3 countries in terms of confirmed cases"),
			style = {"color": "green"}
		),
		dbc.Row(
			[
				dbc.Col(
					dbc.Card(
						data_for_cases("Confirmed", f"{confirmed:,}", f"{newconfirmed:,}"),
						color = "primary",
				...
				dbc.Col(
					dbc.Card(
						data_for_cases("Recovered", f"{recovered:,}", f"{newrecovered:,}"),
						color = "success",
						style = {"text-align": "center"},
						inverse = True
					),
				...
				dbc.Col(
					dbc.Card(
						data_for_cases("Deaths", f"{deaths:,}", f"{newdeaths:,}"),
						color = "danger",
						style = {"text-align": "center"},
						inverse = True
					),
